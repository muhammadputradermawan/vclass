...
class Diskusi extends Super
{
    ...
    function __construct()
    {
        ...
        $this->tabel          = "diskusi";
        $this->active_id_menu = "diskusi";
        $this->nama_view      = "Diskusi";
        $this->status         = true; 
        $this->field_tambah   = array('id_forum','diskusi','soal_diskusi'); 
        $this->field_edit     = array('id_forum','diskusi','soal_diskusi'); 
    ...
    function index(){
            ...
            **/
            $this->crud->set_relation('id_forum','forum','judul');
            $this->crud->set_relation_n_n('soal_diskusi','ticketsol','soal','id_diskusi','id_soal','soal','nomerurut');
            /** Upload **/
