...
class Ticket extends Super
{
    ...
    function __construct()
    {
        ...
        $this->tabel          = "forum";
        $this->active_id_menu = "ticket";
        $this->nama_view      = "Ticket";
        $this->status         = true; 
        $this->field_tambah   = array('judul','id_mata_pelajaran','status'); 
        $this->field_edit     = array('judul','id_mata_pelajaran','status'); 
